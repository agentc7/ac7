/**
 * `ac7 objectives` — team objective management from the terminal.
 *
 * Subcommands:
 *   ac7 objectives list [--mine] [--assignee X] [--status active|blocked|done|cancelled]
 *   ac7 objectives view <id>
 *   ac7 objectives create --title <t> --outcome <o> --assignee <slot> [--body <b>]
 *   ac7 objectives update <id> --status <blocked|active> [--block-reason <r>] [--note <n>]
 *   ac7 objectives complete <id> --result <r>
 *   ac7 objectives cancel <id> [--reason <r>]
 *   ac7 objectives reassign <id> --to <slot> [--note <n>]
 *
 * Create / cancel / reassign require manager+ authority server-side.
