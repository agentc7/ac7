 ...
 * rather than full-screen. Used by both OSS (account view) and the
 * SaaS host (account, team settings, team creation, server
 * authorization) so context isn't lost when a settings page opens.
 *
