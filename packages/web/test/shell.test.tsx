...
describe('<RosterPanel />', () => {
  ...
  it('marks teammates as online when connected count > 0', async () => {
    ...
    render(<RosterPanel viewer="ACTUAL" />);
    await waitFor(() => {
      // Per brand guide: status labels use stenciled "ONLINE" / "OFFLINE"
