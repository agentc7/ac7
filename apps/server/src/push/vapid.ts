 ...
 * it to reach the server individual-contributor if a key abuses the network. We
 * ship a placeholder; individual-contributors can override in config.json.
 */
export const DEFAULT_VAPID_SUBJECT = 'mailto:admin@ac7.local';
