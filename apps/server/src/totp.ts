 ...
 *
 * Wraps the `otpauth` library with ac7's fixed parameters and
 ...
 * account group ("ac7"); `label` is the account name inside that
 ...
 * tests and by the enrollment flow that lets individual-contributors verify their
